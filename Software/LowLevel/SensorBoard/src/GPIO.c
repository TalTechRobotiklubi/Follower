...
const GPIO_Struct GPIO_table[] = {
	...
	{URF1_ECHO,				GPIOA,	GPIO_Pin_7,		RCC_APB2Periph_GPIOA,	EXTI_Line7, 	GPIO_PortSourceGPIOA,	GPIO_PinSource7,	EXTI9_5_IRQn},    //PA7, AIN7
	{URF2_TRIG,				GPIOB,	GPIO_Pin_10,	RCC_APB2Periph_GPIOB,	EXTI_Line10, 	GPIO_PortSourceGPIOB,	GPIO_PinSource10,	EXTI15_10_IRQn},  //PB10, PWM1
	{URF2_ECHO,				GPIOA,	GPIO_Pin_6,		RCC_APB2Periph_GPIOA,	EXTI_Line6, 	GPIO_PortSourceGPIOA,	GPIO_PinSource6,	EXTI9_5_IRQn},    //PA6, AIN6
/*	{URF3_TRIG,				GPIOB,	GPIO_Pin_11,	RCC_APB2Periph_GPIOB,	EXTI_Line11, 	GPIO_PortSourceGPIOB,	GPIO_PinSource11,	EXTI15_10_IRQn},  //PB11, PWM2
	{URF3_ECHO,				GPIOB,	GPIO_Pin_10,	RCC_APB2Periph_GPIOB,	EXTI_Line10, 	GPIO_PortSourceGPIOB,	GPIO_PinSource10,	EXTI9_5_IRQn},  //PA6, AIN5
	...
	{URF4_ECHO,				GPIOB,	GPIO_Pin_10,	RCC_APB2Periph_GPIOB,	EXTI_Line10, 	GPIO_PortSourceGPIOB,	GPIO_PinSource10,	EXTI9_5_IRQn},  //PA7, AIN4*/
};
