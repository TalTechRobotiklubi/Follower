...
const GPIO_Struct GPIO_table[] = {
	...
	{URF_SENSOR1,			GPIOB,	GPIO_Pin_11,	RCC_APB2Periph_GPIOB,	EXTI_Line11, 	GPIO_PortSourceGPIOB,	GPIO_PinSource11,	EXTI15_10_IRQn},  //PB11, PWM2
	{URF_SENSOR2,			GPIOB,	GPIO_Pin_10,	RCC_APB2Periph_GPIOB,	EXTI_Line10, 	GPIO_PortSourceGPIOB,	GPIO_PinSource10,	EXTI15_10_IRQn},  //PB10, PWM1
	{URF_TRIGGER_OUT,		GPIOB,	GPIO_Pin_11,	RCC_APB2Periph_GPIOB,	EXTI_Line11, 	GPIO_PortSourceGPIOB,	GPIO_PinSource11,	EXTI15_10_IRQn}   //PB11, PWM2
};
