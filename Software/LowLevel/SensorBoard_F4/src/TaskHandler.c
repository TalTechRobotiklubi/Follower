...
const TASK_STRUCT TaskHandler_tableOfTasks[] = {
		...
		{TASK_SENSOR2_START,	  200,		    0,			Sensor_TASK_startMeasurement2		},
		{TASK_SENSOR2_READ,		  200,		   49,			Sensor_TASK_readDistance2			},
		{TASK_SENSOR3_START,	  200,		    0,			Sensor_TASK_startMeasurement3		},
		{TASK_SENSOR3_READ,		  200,		   49,			Sensor_TASK_readDistance3			},
