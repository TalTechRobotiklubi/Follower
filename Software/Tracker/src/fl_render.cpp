...
void draw_tracked_bodies(fl_render_context* ctx, const fl_ui_layout* layout,
...
void draw_prediction_plots(fl_render_context* ctx, const fl_ui_layout* layout,
                           const follower_ctx* follower) {
  NVGcontext* nvg = ctx->nvg;
  const float x = layout->toolbar_width;
...
void draw_depth_summary(fl_render_context* ctx, const fl_ui_layout* layout,
                        const follower_ctx* follower) {
